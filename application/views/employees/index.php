    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createEmployee', $user_permission)): ?>
          <a href="<?php echo base_url('employees/create') ?>" class="btn btn-primary">Agregar empleado</a>
          <br /> <br />
        <?php endif; ?>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('products/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p>¿Realmente quieres eliminar el usuario?</p>
        </div>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'employees/fetchEmployeeData',
    'order': []
  });
