            ...
            <form role="form" action="<?php base_url('employees/create') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Cuidad</label>
                      <input type="text" class="form-control" id="city" name="city" autocomplete="off"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Oficina</label>
                      <input type="text" class="form-control" id="office" name="office" autocomplete="off"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="crime">Matricula</label>
                      <input type="text" class="form-control" id="plate" name="plate" autocomplete="off"/>
                    </div>
                  </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#documentPropertyNav").addClass('active');
