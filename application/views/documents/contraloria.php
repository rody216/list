            ...
            <form role="form" action="<?php base_url('employees/create') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Siri</label>
                      <input type="number" class="form-control" id="siri" name="siri" autocomplete="off"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Hora de hechos</label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Sanción</label>
                      <input type="text" class="form-control" id="sanction" name="sanction" autocomplete="off"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Providencia</label>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#btnSearchPerson").click(function() {
      ...
      $.ajax({
        url: base_url+'documents/fetchPersonByDocumentNumber/contraloria/'+document_type_id+'/'+document_number,
        method: "POST",
        dataType: "json",
        success: function (response) {
          if (response != null) {
            ...
            if(response.document != null) {
              ...
              $("#certificate_number").val(response.document.certificate_number)
              $("#siri").val(response.document.siri)
              $("#time_issue").val(response.document.time_issue)
              $("#results").val(response.document.results)
              $("#sanction").val(response.document.sanction)
              $("#providence").val(response.document.providence)
            }
          }
        },
