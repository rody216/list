            ...
            <form role="form" action="<?php base_url('employees/create') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Número de Comparendo</label>
                      <input type="number" class="form-control" id="processes_number" name="processes_number" autocomplete="off"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Fecha del Comparendo</label>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#documentSimitNav").addClass('active');
