            ...
            <form role="form" action="<?php base_url('employees/create') ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="product_name">Número de expendiente</label>
                      <input type="text" class="form-control" id="file_number" name="file_number" autocomplete="off"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="form-group">
                  <label for="detail">Medidas correctivas</label>
                  <textarea class="form-control" id="measures" name="measures" autocomplete="off"></textarea>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#documentRnmcNav").addClass('active');
    ...
    $("#btnSearchPerson").click(function() {
      ...
      $.ajax({
        url: base_url+'documents/fetchPersonByDocumentNumber/rnmc/'+document_type_id+'/'+document_number,
        method: "POST",
        dataType: "json",
        success: function (response) {
          if (response != null) {
            ...
            if(response.document != null) {
              ...
              $("#file_number").val(response.document.file_number)
              ...
              $("#measures").val(response.document.measures)
            }
          }
        },
        error: function (xhr, status, error) {
